...
underneath. The [first-manuscript tutorial](first-manuscript.qmd)
...
- [First manuscript (15 min)](first-manuscript.qmd) — end-to-end
  onramp; works identically with `.ipynb` source.
- [CLI reference: `scan`](cli.qmd#quartobot-scan) — every flag,
  every exit code.
